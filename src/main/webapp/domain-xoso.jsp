        ...
        <div id="contentmodule" style="margin-left: 100px">
          <div class="mainbody" id="pagecontent">
            <div id="page_content">
              ...
              <input type="text" value="<%=domainId%>" id="domain-id" style="display: none">
...
<script>
  ...
  function searchByName(param, param2) {
    ...
    if (txtSearch.length > 0) {
      $.ajax({
        url: "/Xoso_Datawarehouse_war/search-domain",
        type: "get",
        data: {
          txt: txtSearch,
          idDomain : domain
